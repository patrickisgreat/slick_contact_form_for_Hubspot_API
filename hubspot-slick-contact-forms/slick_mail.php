...
require_once("../hap/class.leads.php");

$action = $_POST['action'];
//initialize Hubspot API vars
$PING_Hub_Key = '464b90b1-ac0e-40f4-af4f-3cec812a67b5';
$leads = new Leads($PING_Hub_Key);
$api_url = 'http://pingtechgroup.app12.hubspot.com/?app=leaddirector&FormName=new_test_2';

if ($action == "submit") {
	//Update Hubspot Leads API
	$postValues = array('firstName' => $_POST['firstName'],
						'lastName' => $_POST['lastName'], 
						'Email' => $_POST['Email'], 
						'Company' => $_POST['company'],
						'UserToken' => $_COOKIE['hubspotutk'],
						'IPAddress' => $_SERVER['REMOTE_ADDR']
						);
    echo $leads->add_lead($api_url, $postValues);
	...
	$valid4 = isset($_POST["valid4"]) ? $_POST["valid4"] : "";
	$input1 = isset($_POST["firstName"]) ? stripslashes($_POST["firstName"]) : "";
	$input2 = isset($_POST["lastName"]) ? stripslashes($_POST["lastName"]) : "";
	$input3 = isset($_POST["Email"]) ? stripslashes($_POST["Email"]) : "";
	$input4 = isset($_POST["company"]) ? stripslashes($_POST["company"]) : "";
