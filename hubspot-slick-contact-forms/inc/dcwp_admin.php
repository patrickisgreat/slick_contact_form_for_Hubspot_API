...
class dc_jqslickcontact_widget extends WP_Widget {
			  ...
			  <fieldset>
			    <ol>
				  <?php 
					...
					<?php if($valid1 > '-1'){ ?>
				  <li class="input-row">
				    <label for="firstName"><?php echo $label1; ?></label>
					<input class="<?php echo $this->dcscf_validation($widget_options['valid1'], 'defaultText text-input'); ?>" name="firstName" value="" title="<?php echo $label1; ?>" />
					<input type="hidden" name="valid1" value="<?php echo $valid1; ?>" />
				  </li>
				    <?php } ?>
					<?php if($valid2 > '-1'){ ?>
				  <li class="input-row">	
				    <label for="lastName"><?php echo $label2; ?></label>
					<input class="<?php echo $this->dcscf_validation($widget_options['valid2'], 'defaultText text-input'); ?>" name="lastName" value="" title="<?php echo $label2; ?>" />
					<input type="hidden" name="valid2" value="<?php echo $valid2; ?>" />
				  </li>
				  <?php } ?>
				  <?php if($valid3 > '-1'){ ?>
				  <li class="input-row">	
				    <label for="Email"><?php echo $label3; ?></label>
					<input class="<?php echo $this->dcscf_validation($widget_options['valid3'], 'defaultText text-input'); ?>" name="Email" value="" title="<?php echo $label3; ?>" />
					<input type="hidden" name="valid3" value="<?php echo $valid3; ?>" />
				  </li>
				  <?php } ?>
				   <?php if($valid4 > '-1'){ ?>
				  <li class="input-row">	
				    <label for="company"><?php echo $label4; ?></label>
					<input class="<?php echo $this->dcscf_validation($widget_options['valid4'], 'defaultText text-input'); ?>" name="company" value="" title="<?php echo $label4; ?>" />
					<input type="hidden" name="valid4" value="<?php echo $valid4; ?>" />
				  </li>
				  <?php } ?>
				  <?php if($validText > '-1'){ ?>
				  <li class="text-row">	
				  ...
				  <li class="button-row">
					...
					<?php
						...
						echo $label4 != '' ? '<input type="hidden" name="label4" value="'.$label4.'" />' : '';
    ...
    function update( $new_instance, $old_instance ) {
		...
		$instance['label4'] = strip_tags( stripslashes($new_instance['label4']) );
		...
		$instance['valid4'] = strip_tags( stripslashes($new_instance['valid4']) );
	...
	<ul class="dcscf-ul">
	  ...
	  <li>
	    <?php echo $this->dcscf_widget_text_input('4',$this->get_field_id('label4'), $this->get_field_name('label4'), $widget_options['label4'], $this->get_field_name('valid4'), $this->get_field_id('valid4'), $widget_options['valid4'],'1'); ?>
	  </li>
	  <li>
	  ...
	  <li>
	    <?php echo $this->dcscf_widget_text_input('5',$this->get_field_id('labelText'), $this->get_field_name('labelText'), $widget_options['labelText'], $this->get_field_name('validText'), $this->get_field_id('validText'), $widget_options['validText'],'0'); ?>
	  </li>
	</ul>
	<p class="dcwp-row">
